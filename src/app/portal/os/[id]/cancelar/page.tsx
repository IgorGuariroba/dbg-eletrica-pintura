...
import { AlertTriangle, AlertCircle, MessageSquare, ArrowLeft } from "lucide-react";
      ...
      {restrito ? (
        <Card className="border-destructive bg-destructive/5 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-xl font-bold text-destructive">Cancelamento Restrito</CardTitle>
          ...
          <CardContent className="space-y-6 text-center text-sm md:text-base text-muted-foreground">
            <p>
              Por questões operacionais, cancelamentos com menos de 24 horas de antecedência não podem ser realizados de forma autônoma.
            </p>
            ...
            <div className="pt-4">
              <Link
                href={urlWhatsApp(`Olá! Preciso cancelar a visita da OS #${os.id.slice(0, 8)} agendada para ${dataCurta(os.agendadoPara)}.`) as Route}
